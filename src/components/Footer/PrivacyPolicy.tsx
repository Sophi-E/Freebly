...
const PrivacyPolicy = () => {
  return (
    <div style={{ fontFamily: 'Helvetica', padding: '1em' }}>
      ...
      <p>
        Freebly built the Freebly app as a Free app. This SERVICE is provided by
        Freebly at no cost and is intended for use as is.
      </p>{' '}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at Freebly unless otherwise
      ...
      <p>
        ...
        not hesitate to contact us at www.freebly.com.
      </p>{' '}
      <p>
