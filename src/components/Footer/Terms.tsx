...
const Terms = () => {
  return (
    <div style={{ fontFamily: 'Helvetica', padding: '1em' }}>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Sophia
        Enakpoya & Genius Izuchi.
      </p>{' '}
      <p>
        Sophia Enakpoya & Genius Izuchi are committed to ensuring that the app
        ...
        time and for any reason. We will never charge you for the app or its
        services without making it very clear to you exactly what you’re paying
        for.
      </p>{' '}
      <p>
        The Freebly app stores and processes personal data that you have
        provided to us, in order to provide [my/our] Service. It’s your
        ...
        phone’s security features and it could mean that the Freebly app won’t
        work properly or at all.
      </p>{' '}
      <p>
        You should be aware that there are certain things that Sophia Enakpoya &
        Genius Izuchi will not take responsibility for. Certain functions of the
        ...
        but Sophia Enakpoya & Genius Izuchi cannot take responsibility for the
        app not working at full functionality if you don’t have access to Wi-Fi,
      ...
      <p>
        Along the same lines, Sophia Enakpoya & Genius Izuchi cannot always take
        ...
        turn it on to avail the Service, Sophia Enakpoya & Genius Izuchi cannot
        accept responsibility.
      </p>{' '}
      <p>
        With respect to Sophia Enakpoya & Genius Izuchi’s responsibility for
        ...
        to us so that we can make it available to you. Sophia Enakpoya & Genius
        Izuchi accepts no liability for any loss, direct or indirect, you
      ...
      <p>
        ...
        app. Sophia Enakpoya & Genius Izuchi do not promise that it will always
      ...
      <p>
        [I/We] may update our Terms and Conditions from time to time. Thus, you
        are advised to review this page periodically for any changes. [I/We]
      ...
      <p>
        If you have any questions or suggestions about [my/our] Terms and
        Conditions, do not hesitate to contact [me/us] at [App Contact
        informations].
      </p>{' '}
      <p>
